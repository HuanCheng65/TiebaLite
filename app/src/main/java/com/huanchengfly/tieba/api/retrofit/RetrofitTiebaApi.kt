...
import com.huanchengfly.tieba.api.interceptors.SortAndSignInterceptor
import com.huanchengfly.tieba.api.retrofit.converter.gson.GsonConverterFactory
import com.huanchengfly.tieba.api.retrofit.interceptors.*
import com.huanchengfly.tieba.api.retrofit.interfaces.MiniTiebaApi
import com.huanchengfly.tieba.api.retrofit.interfaces.NewTiebaApi
import com.huanchengfly.tieba.api.retrofit.interfaces.OfficialTiebaApi
import com.huanchengfly.tieba.api.retrofit.interfaces.WebTiebaApi
...
object RetrofitTiebaApi {
    ...
    private val defaultCommonParamInterceptor = CommonParamInterceptor(
            Param.BDUSS to { AccountUtil.getBduss(BaseApplication.getInstance()) },
            ...
            Param.NET_TYPE to { "1" },
            Param.PHONE_IMEI to { MobileInfoUtil.getIMEI(BaseApplication.getInstance()) },
    ...
    val WEB_TIEBA_API: WebTiebaApi by lazy {
        createAPI<WebTiebaApi>("https://tieba.baidu.com/",
                CommonHeaderInterceptor(
                        ...
                        Header.USER_AGENT to { WebSettings.getDefaultUserAgent(BaseApplication.getInstance()) }
                ),
