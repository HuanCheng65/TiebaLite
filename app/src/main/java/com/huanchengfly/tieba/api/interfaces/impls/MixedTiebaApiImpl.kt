package com.huanchengfly.tieba.api.interfaces.impls
...
object MixedTiebaApiImpl : ITiebaApi {
    ...
    override fun userLikeForum(
        ...
        val myUid = AccountUtil.getUid(BaseApplication.getInstance())
    ...
    override fun threadStore(page: Int, pageSize: Int): Call<ThreadStoreBean> =
            RetrofitTiebaApi.NEW_TIEBA_API.threadStore(pageSize, pageSize * page, AccountUtil.getUid(BaseApplication.getInstance()))
    ...
    override fun webUploadPic(photoInfoBean: PhotoInfoBean): Call<WebUploadPicBean> {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            ...
            try {
                BaseApplication.getInstance().contentResolver.openAssetFileDescriptor(photoInfoBean.fileUri, "r")?.use { afd ->
