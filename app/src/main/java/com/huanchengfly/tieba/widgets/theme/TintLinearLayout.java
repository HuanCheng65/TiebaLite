...
public class TintLinearLayout extends LinearLayout implements Tintable {
    ...
    public TintLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TintLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
