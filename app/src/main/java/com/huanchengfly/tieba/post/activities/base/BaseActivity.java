package com.huanchengfly.tieba.post.activities.base;
...
public abstract class BaseActivity extends SwipeBackActivity implements ExtraRefreshable {
    ...
    protected void getDeviceDensity() {
        ...
        Config.EXACT_SCREEN_HEIGHT = height;
        Config.EXACT_SCREEN_WIDTH = width;
        float density = metrics.density;
        Config.DENSITY = metrics.density;
        Config.SCREEN_HEIGHT = (int) (height / density);
        Config.SCREEN_WIDTH = (int) (width / density);
    }
