...
public class RecyclerViewOverScrollDecorAdapter implements IOverScrollDecoratorAdapter {
    ...
    /**
     * A delegation of the mAdapter implementation of this view that should provide the processing
    ...
    public RecyclerViewOverScrollDecorAdapter(RecyclerView recyclerView) {
        ...
        {
            throw new IllegalArgumentException("Recycler views with custom layout managers are not supported by this mAdapter out of the box." +
                    "Try implementing and providing an explicit 'impl' parameter to the other c'tors, or otherwise create a custom mAdapter subclass of your own.");
        }
    }
