...
class ZyqFriendLinkAdapter(context: Context, items: List<ForumPageBean.ZyqDefineBean>) :
    BaseSingleTypeAdapter<ForumPageBean.ZyqDefineBean>(context, items) {
    ...
    override fun convert(
        ...
        item: ForumPageBean.ZyqDefineBean,
        position: Int
    ) {
