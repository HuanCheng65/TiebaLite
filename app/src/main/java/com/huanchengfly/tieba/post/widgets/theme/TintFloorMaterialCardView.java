...
public class TintFloorMaterialCardView extends MaterialCardView implements Tintable {
    ...
    */
    ...
    public TintFloorMaterialCardView(@NonNull Context context) {
        this(context, null);
    }

    public TintFloorMaterialCardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TintFloorMaterialCardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    */
    ...
    private void applyTintColor() {
        ...
        int bg = ThemeUtils.getColorById(getContext(), R.color.default_color_floor_card);
        try {
